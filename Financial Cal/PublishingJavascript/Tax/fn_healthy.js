...
function gen_HL_Graph(varPercent, varID, varBase) {
    ...
    if (varPercent == 0) {
        ...
        pos_Line = 204 - ((varPercent / 100) * (210));
    }
    ...
    arr[3][1] = 'คุณมีภาระในการผ่อนชำระหนี้อยู่ในระดับที่เหมาะสมแล้ว';
    arr[3][2] = 'คุณมีภาระในการผ่อนชำระหนี้อยู่ในระดับที่เหมาะสมแล้ว';
    arr[3][3] = 'คุณมีภาระในการผ่อนชำระหนี้สูงเกินไป และมีโอกาสที่จะผิดนัดชำระคืนหนี้ได้ ไม่ครวก่อหนี้เพิ่มอย่างยิ่ง หากเป็นไปได้ให้นำเงินสินทรัพย์สภาพคล่องส่วนเกินมาชำระหนี้บางส่วน เพื่อผ่อนคลายภาระในการผ่อนชำระหนี้รายเดือนได้';
    arr[3][4] = 'คุณไม่มีภาระหนี้ต้องชำระ และมีความสามารถในการก่อหนี้เพิ่มเติมได้';

    arr[4][1] = 'คุณมีภาระการผ่อนชำระหนี้สินที่ไม่จดจำนอง เช่น รถยนต์ บัตรเครดิต อยู่ในระดับที่เหมาะสมแล้ว';
    arr[4][2] = 'คุณมีภาระการผ่อนชำระหนี้สินที่ไม่จดจำนอง เช่น รถยนต์ บัตรเครดิต อยู่ในระดับที่เหมาะสมแล้ว';
    arr[4][3] = 'คุณมีภาระการผ่อนชำระหนี้สินที่ไม่จดจำนอง เช่น รถยนต์ บัตรเครดิต ที่สูงเกินไป แสดงให้เห็นถึงความไม่มั่นคง ทางการเงิน มีโอกาสที่จะผิดนัดชำระคืนหนี้ได้ ไม่ครวก่อหนี้เพิ่มเป็นอย่างยิ่ง';
    arr[4][4] = 'คุณไม่มีภาระหนี้ต้องชำระ และมีความสามารถในการก่อหนี้เพิ่มเติมได้';

    arr[5][1] = 'คุณมีสัดส่วนการออมน้อยกว่าเกณฑ์มาตรฐาน ครวเพิ่มยอมเงินออมในแต่ละเดือน โดยใช้เทคนิคออมก่อนใช้';
