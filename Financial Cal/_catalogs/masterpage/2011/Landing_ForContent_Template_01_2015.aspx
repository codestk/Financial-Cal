...
<div id="divContent" style="width:990px;height:auto;color:gray;font-size:small;">
	<table style="width:990px;height:auto;padding-top:15px;" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width:100%;" colspan="5">
				<WebPartPages:WebPartZone id="WPZone_1" runat="server" title="Zone1"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
				<PublishingWebControls:RichHtmlField FieldName="ContentBody08" ID="ContentBody08" runat="server"></PublishingWebControls:RichHtmlField></td>				
		</tr>
		<tr>
			<td style="width:470px;padding-left:15px;" colspan="2">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody02" ID="ContentBody02" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody03" ID="ContentBody03" runat="server"></PublishingWebControls:RichHtmlField></td>			
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody04" ID="ContentBody04" runat="server"></PublishingWebControls:RichHtmlField></td>			
			<td style="width:15px;"></td>			
		</tr>	
		<tr>
			<td style="width:470px;padding-left:15px;" colspan="2">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody05" ID="ContentBody05" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody06" ID="ContentBody06" runat="server"></PublishingWebControls:RichHtmlField></td>			
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody07" ID="ContentBody07" runat="server"></PublishingWebControls:RichHtmlField></td>			
			<td style="width:15px;"></td>			
		</tr>			
		<tr>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody18" ID="ContentBody18" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody19" ID="ContentBody19" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody20" ID="ContentBody20" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:225px;padding-left:15px;">
				<PublishingWebControls:RichHtmlField FieldName="ContentBody21" ID="ContentBody21" runat="server"></PublishingWebControls:RichHtmlField></td>
			<td style="width:15px;"></td>
		</tr>				
	</table>
</div>
